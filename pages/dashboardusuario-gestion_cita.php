...
<html lang="en">
    <head>
        ...
        <title>Gestion Cita Usuario</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseCitas" aria-labelledby="headingCitas" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="#">Gestion de citas</a>
...
<!-- Content -->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <table class="table table-hover">
                            <thead>
                                ...
                                <th scope="col">Estado por Admin</th>
        ...
        <script type="module" src="../scripts/dashboard-pagos.js"></script>
    </body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        ...
        <script src="../scripts/dashboardusuario-gestion_cita.js"></script>
</html>
